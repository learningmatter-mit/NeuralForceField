...
This code repository is developed in the [Learning Matter Lab](https://gomezbombarelli.mit.edu) (led by prof. Rafael Gomez-Bombarelli) at MIT.
...
```bash
conda upgrade conda
conda create -n nff python=3.7 scikit-learn pytorch>=1.4.0 cudatoolkit=10.0 ase pandas pymatgen sympy -c pytorch -c conda-forge
```
