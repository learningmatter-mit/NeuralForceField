...
class Reactive_Dynamics:
    def __init__(
        ...
        self.integrator = integrator(
            self.atomsbatch, self.mdparam["time_step"] * fs, self.temperature * kB, self.friction
        )
        ...
        self.integrator.attach(
            NeuralMDLogger(self.integrator, self.atomsbatch, self.mdparam["thermo_filename"], mode="a"),
