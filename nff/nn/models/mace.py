...
from nff.modules.mace.scatter import scatter_sum

from nff.modules.mace.blocks import (
    AtomicEnergiesBlock,
...
from nff.modules.maces.utils import (
...
class BOTNet(torch.nn.Module):
    ...
    def forward(self, data: AtomsBatch, training=False) -> Dict[str, Any]:
        # Setup
