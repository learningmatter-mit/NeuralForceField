...
`scripts/cp3d/hyperopt/run_hyperopt.sh` is a script for running Bayesian hyperparameter optimization. The config file is `scripts/cp3d/hyperopt/search_config.json`. Its keys are:
