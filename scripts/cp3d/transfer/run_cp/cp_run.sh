...
model_0_path="/home/saxelrod/chemprop_cov_2/make_splits/cl_protease"

cwd="/home/saxelrod/chemprop_cov_2/make_splits/cl_protease"
...
for features in ${feat_options[@]}; do
    for mpnn in ${mpnn_options[@]}; do
        for metric in ${metrics[@]}; do
            ...
            # cmd="python /home/saxelrod/Repo/projects/chemprop/train.py "
            ###
            cmd="python /home/saxelrod/Repo/projects/chemprop/hyperparameter_optimization.py "
            cmd=$cmd" --num_iters 100"
            ###

            cmd=$cmd" --data_path /home/saxelrod/chemprop_cov_2/make_splits/cl_protease/train_full.csv "
            cmd=$cmd" --separate_val_path /home/saxelrod/chemprop_cov_2/make_splits/cl_protease/val_full.csv "
            cmd=$cmd" --separate_test_path /home/saxelrod/chemprop_cov_2/make_splits/cl_protease/test_full.csv "
