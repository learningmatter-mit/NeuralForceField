...
if params['id'] == None:
    experiment = conn.experiments().create(
        ...
        parameters=[
            ...
            dict(name='feat_dim', type="int", bounds=dict(min=6, max=8), default_value=7),  # 64->256
            dict(name='n_rbf', type='int', bounds=dict(min=2, max=6), default_value=3),  # 4->64
...
while experiment.progress.observation_count < experiment.observation_budget:
    ...
    trainparam['readout_dropout'] = 0.0
    print(trainparam)
